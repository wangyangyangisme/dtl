...
template<class DataObj, class ParamObj = DefaultParamObj<DataObj> >
  ...
  public STD_::random_access_iterator<DataObj, ptrdiff_t>
#else
  #ifdef _MSC_VER
    ...
    public STD_::iterator<STD_::random_access_iterator_tag, DataObj, ptrdiff_t, const DataObj *, const DataObj &>
  #endif
#endif
{ 
private:
...
public:
	...
	typedef ptrdiff_t this_difference;
#else
