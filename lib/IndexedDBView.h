...
#  else
		...
		typedef STD_::reverse_bidirectional_iterator<iterator, DataObj, DataObj &, ptrdiff_t> reverse_iterator;
		typedef STD_::reverse_bidirectional_iterator<const_iterator, DataObj, const DataObj &, ptrdiff_t> const_reverse_iterator;
#  endif
#endif
