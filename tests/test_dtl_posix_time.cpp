...
void Test_dtl_posix_time()
{
   ...
   vector<dtl_posix_time> copy1;
   copy(plain_view.begin(),plain_view.end(), back_inserter(copy1));
   ...
   vector<dtl_posix_time> copy2;
   copy(view.begin(),view.end(), back_inserter(copy2));
